...
#import "ILA_StaticData_ChampionDto.h"
...
+ (void)getChampionInfoFor:(int)champId withData:(NSString *)champDataSelected :(void (^)(ILA_StaticData_ChampionDto *championInfo))completionBlock;
